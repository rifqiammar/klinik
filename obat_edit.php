...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
  <table  class="table-list" width="100%" border="0" cellspacing="1" cellpadding="3">
    <tr>
      ...
      <td width="83%"><input type="text" name="textfield" value="<?php echo $dataKode; ?>" size="14" maxlength="10" readonly="readonly"/>
    ...
    <tr>
      ...
      <td><strong>:</strong></td>
      <td><input type="text" name="txtHargaModal" value="<?php echo $dataHargaModal; ?>" size="20" maxlength="12" 
