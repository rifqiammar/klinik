...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
  <table class="table-list" width="100%" border="0" cellspacing="1" cellpadding="3">
    <tr>
      ...
      <td width="83%"><input type="text" name="textfield" value="<?php echo $dataKode; ?>" size="10" maxlength="10" readonly="readonly"/>
      <input name="txtKode" type="hidden" value="<?php echo $dataKode; ?>" /></td>
    </tr>
    <tr>
      <td><strong>Nama Dokter </strong></td>
      <td><strong>:</strong></td>
      <td><input type="text" name="txtNama" value="<?php echo $dataNama; ?>" size="80" maxlength="100" />
    ...
    <tr>
      ...
      <td><strong>:</strong></td>
      <td><input type="text" name="txtTempatLahir" value="<?php echo $dataTempatLahir; ?>" size="40" maxlength="100" />
        , <?php echo listTanggal("Lahir",$dataTglLahir); ?></td>
    </tr>
    <tr>
      <td><strong>Alamat Tinggal </strong></td>
      <td><strong>:</strong></td>
      <td><input type="text" name="txtAlamat" value="<?php echo $dataAlamat; ?>" size="80" maxlength="200" /></td>
    </tr>
    <tr>
      <td><strong>No Telepon </strong></td>
      <td><strong>:</strong></td>
      <td><input type="text" name="txtTelepon" value="<?php echo $dataTelepon; ?>" size="20" maxlength="20" /></td>
    </tr>
    <tr>
      <td><strong>SIP</strong></td>
      <td><strong>:</strong></td>
      <td><input type="text" name="txtSIP" value="<?php echo $dataSIP; ?>" size="60" maxlength="20" /></td>
    </tr>
    <tr>
      <td><strong>Spesialisasi</strong></td>
      <td><strong>:</strong></td>
      <td><input type="text" name="txtSpesialis" value="<?php echo $dataSpesialis; ?>" size="60" maxlength="60" /></td>
    </tr>
    <tr>
      <td><strong>Bagi Hasil (%) </strong></td>
      <td><strong>:</strong></td>
      <td><input  type="text" name="txtBagiHasil"  value="<?php echo $dataBagiHasil; ?>" size="20" maxlength="12" /></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
