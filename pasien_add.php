...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" target="_self">
  <table  class="table-list" width="100%" border="0" cellspacing="1" cellpadding="3">
    <tr>
      ...
      <td width="84%"><input type="text" name="textfield" value="<?php echo $dataKode; ?>" size="10" maxlength="10" readonly="readonly"/></td>
    </tr>
    <tr>
      <td><strong>Nama Pasien </strong></td>
      <td><strong>:</strong></td>
      <td><input type="text" name="txtNama" value="<?php echo $dataNama; ?>" size="80" maxlength="100" /></td>
    </tr>
    <tr>
      <td><strong>No. Identitas (KTP/SIM) </strong></td>
      <td><strong>:</strong></td>
      <td><input type="text" name="txtNoIdentitas" value="<?php echo $dataNoIdentitas; ?>" size="40" maxlength="40" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><strong>:</strong></td>
      <td><input type="text" name="txtKlgNama" value="<?php echo $dataKlgNama; ?>" size="80" maxlength="200" /></td>
    </tr>
    <tr>
      <td><strong>No. Telepon </strong></td>
      <td><strong>:</strong></td>
      <td><input type="text" name="txtKlgTelepon" value="<?php echo $dataKlgTelepon; ?>" size="20" maxlength="20" /></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
