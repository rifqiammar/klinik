...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
  <table  class="table-list" width="100%" border="0" cellspacing="1" cellpadding="3">
    <tr>
      ...
      <td width="83%"><input type="text" name="textfield" value="<?php echo $dataKode; ?>" size="14" maxlength="10" readonly="readonly"/></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><strong>:</strong></td>
      <td><input type="number" name="txtHargaModal" value="<?php echo $dataHargaModal; ?>" size="20" maxlength="12" 
    ...
    <tr>
      ...
      <td><strong>:</strong></td>
      <td><input type="number" name="txtHargaJual" value="<?php echo $dataHargaJual; ?>" size="20" maxlength="12" 
	  			onblur="if (value == '') {value = '0'}" 
				onfocus="if (value == '0') {value =''}"/></td>
    </tr>
    <tr>
      ...
      <td><strong>:</strong></td>
      <td><input type="text" name="txtStok" value="<?php echo $dataStok; ?>" size="14" maxlength="10"/></td>
    </tr>
    <tr>
