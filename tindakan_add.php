...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self" id="form1">
  <table width="100%" class="table-list" border="0" cellpadding="4" cellspacing="1">
    <tr>
      ...
      <td width="3">:</td>
      <td width="1019"><input type="text" name="textfield" value="<?php echo $dataKode; ?>" size="10" maxlength="10" readonly="readonly"/></td>
    </tr>
    <tr>
      <td><strong>Nama Tindakan </strong></td>
      <td>:</td>
      <td><input type="text" name="txtNama" value="<?php echo $dataNama; ?>" size="70" maxlength="100" /></td>
    </tr>
    <tr>
      <td><strong>Harga (Rp.) </strong></td>
      <td>:</td>
      <td><input type="text" name="txtHarga" value="<?php echo $dataHarga; ?>" size="20" maxlength="12" /></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
