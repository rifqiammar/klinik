...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
  <table width="100%" class="table-list" border="0" cellpadding="4" cellspacing="1">
    <tr>
      ...
      <td width="3">:</td>
      <td width="1019"><input type="text" name="textfield" value="<?php echo $dataKode; ?>" size="10" maxlength="10" readonly="readonly"/>
      <input name="txtKode" type="hidden" value="<?php echo $dataKode; ?>" /></td>
    </tr>
    <tr>
      <td><strong>Nama Tindakan </strong></td>
      <td>:</td>
      <td><input type="text" name="txtNama" value="<?php echo $dataNama; ?>" size="70" maxlength="100" />
