...
if(isset($_POST['btnSimpan'])){
	...
	if (count($pesanError)>=1 ){
		...
		if($myQry){			
			...
			echo "<script>";
			echo "window.open('pendaftaran/pendaftaran_cetak.php?Kode=$kodeBaru','popuppage','width=920,toolbar=0,resizable=0,scrollbars=yes,height=720,top=10,left=300')";
			echo "</script>";
			
			// Refresh halaman 
			echo "<meta http-equiv='refresh' content='0; url=?page=Pendaftaran'>";
		}
		exit;
	}	
...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
  <table class="table-list" width="100%" border="0" cellspacing="1" cellpadding="3">
    <tr>
      ...
      <td width="80%"><input type="text" name="textfield" value="<?php echo $dataKode; ?>" size="10" maxlength="10" readonly="readonly"/></td>
    </tr>
    <tr>
      <td><strong>Nomor RM </strong></td>
      <td><strong>:</strong></td>
      <td><input type="text" name="txtNomorRM" value="<?php echo $NomorRM; ?>" size="23" maxlength="10" />
      * pilih dari <a href="?page=Pencarian-Pasien" target="_self">daftar pasien</a>, lalu klik menu <strong>daftar</strong> </td>
    </tr>
    <tr>
      <td><strong>Nama Pasien </strong></td>
      <td><strong>:</strong></td>
      <td><input type="text" name="txtPasien" value="<?php echo $dataPasien; ?>" size="80" maxlength="100" readonly="readonly"/></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input name="txtTglJanji" type="text" class="tcal" value="<?php echo $dataTglJanji; ?>" />
        / 
        <input type="text" name="txtJamJanji" value="<?php echo $dataJamJanji; ?>" size="10" maxlength="8" />
        <strong>ex:</strong> 12:30 </td>
    </tr>
    <tr>
      <td><strong>Keluhan Pasien </strong></td>
      <td><strong>:</strong></td>
      <td><input type="text" name="txtKeluhan" value="<?php echo $dataKeluhan; ?>" size="80" maxlength="100" /></td>
    </tr>
    <tr>
...
<a href="?page=Pendaftaran-Tampil" target="_self">Tampil Pendaftaran </a>