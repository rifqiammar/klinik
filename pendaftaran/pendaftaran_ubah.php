...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
  <table class="table-list" width="100%" border="0" cellspacing="1" cellpadding="3">
    ...
    <tr>
      ...
      <td><strong>:</strong></td>
      <td><input type="text" name="txtNomorRM" value="<?php echo $dataNomorRM; ?>" size="23" maxlength="10" /></td>
    </tr>
    <tr>
      <td><strong>Nama Pasien </strong></td>
      <td><strong>:</strong></td>
      <td><input type="text" name="txtPasien" value="<?php echo $dataPasien; ?>" size="80" maxlength="20" readonly="readonly"/></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><strong>:</strong></td>
      <td><input type="text" name="txtKeluhan" value="<?php echo $dataKeluhan; ?>" size="80" maxlength="20" /></td>
    </tr>
    <tr>
